  ...
  return (
    ...
    <header className='header' ref={setRef}>
      <div className='header__image-container'>
        <img
          className={`header__image header__image--${
      ...
      <div
        className={`heading-primary heading-primary--${
          visible ? 'visible' : 'invisible'
        }`}
      >
        Thomas Nelson
      ...
      <div
        className={`divider divider--${visible ? 'visible' : 'invisible'}`}
      ></div>
      <div
        className={`heading-subtitle heading-subtitle--${
          visible ? 'visible' : 'invisible'
        }`}
      >
